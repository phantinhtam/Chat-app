...
public class SocketThread implements Runnable{
    ...
    private void createConnection(String receiver, String sender, String filename){
        try {
            serverMainForm.appendMessage("[createConnection]: Tạo kết nối chia sẻ tệp.");
            ...
            if(s != null){ 
                ...
                serverMainForm.appendMessage("[createConnection]: Không tìm thấy khách hàng '" + receiver + "'");
                DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + receiver + "' không được tìm thấy trong danh sách, hãy chắc chắn rằng nó nằm trong danh sách trực tuyến.!");
            }
        } catch (IOException iOException) {
    ...
    public void run() {
        try {
            while(true){
                ...
                switch(CMD){
                    case "CMD_JOIN":
                        ...
                        serverMainForm.appendMessage("[Client]: " + clientUsername + " Tham gia phòng trò chuyện.!");
                        serverMainForm.appendMessage("[Client]: " + clientUsername + " tại " + socket.getInetAddress().toString() + " trên cổng " + socket.getPort());
                        break;
                    ...
                    case "CMD_CHAT":
                        ...
                        try {
                            ...
                            serverMainForm.appendMessage("[Message]: Đến " + from + " từ " + sendTo + " : " + msg);
                        } catch (IOException iOException) {  
                            System.out.println(iOException.getMessage());
                            serverMainForm.appendMessage("[IOException]: Không thể gửi tin nhắn đến " + sendTo); 
                        }
                        break;
                    ...
                    case "CMD_SHARINGSOCKET":
                        serverMainForm.appendMessage("CMD_SHARINGSOCKET : Máy khách thiết lập kết nối để chia sẻ tệp...");
                        ...
                        serverMainForm.appendMessage("CMD_SHARINGSOCKET : Chia sẻ tệp hiện đã mở");
                        break;
                    
                    case "CMD_SENDFILE":
                        serverMainForm.appendMessage("CMD_SENDFILE : Máy khách gửi tệp...");
                        /*
                        ...
                        */
                        ...
                        serverMainForm.appendMessage("CMD_SENDFILE : Đến: "+ consignee);
                        serverMainForm.appendMessage("CMD_SENDFILE : Từ: "+ sendto);
                        /**  Get the client Socket **/
                        serverMainForm.appendMessage("CMD_SENDFILE : Chuẩn bị kết nối..");
                        ...
                        if(cSock != null){ /* Exists   */
                            try {
                                serverMainForm.appendMessage("CMD_SENDFILE : Đã kết nối..!");
                                /** First Write the filename..  **/
                                serverMainForm.appendMessage("CMD_SENDFILE : Gửi tập tin đến khách hàng...");
                                ...
                                serverMainForm.appendMessage("CMD_SENDFILE : Tệp đã được gửi đến khách hàng...");
                            } catch (IOException iOException) {
                            ...
                            serverMainForm.removeClientFileSharing(consignee);
                            serverMainForm.appendMessage("CMD_SENDFILE : Khách '" + sendto + "' không tìm thấy.!");
                            DataOutputStream dataOutputStream = new DataOutputStream(socket.getOutputStream());
                            dataOutputStream.writeUTF("CMD_SENDFILEERROR " + "Khách '" + sendto + "' không tìm thấy, Chia sẻ tệp sẽ thoát.");
                        }                        
                        break;
                    ...
                    default: 
                        serverMainForm.appendMessage("[CMDException]: Lệnh không xác định " + CMD);
                    break;
                }
            }
        } catch (IOException iOException) {
            ...
            System.out.println("Chia sẻ tệp: " + filesharing_username);
            System.out.println(iOException.getMessage());
            ...
            serverMainForm.appendMessage("[SocketThread]: Kết nối máy khách đã đóng..!");
        }
    }
